{
  ...
  '#':: d.pkg(name='scanType', url='', help='"ScanType is the Schema for the scantypes API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ScanType', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'execution.securecodebox.io/v1',
    kind: 'ScanType',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ScanTypeSpec defines the desired state of ScanType"'),
  spec: {
    '#extractResults':: d.obj(help='"ExtractResults configures where the secureCodeBox can find the results of the scan once the scanner container exited."'),
    extractResults: {
      '#withLocation':: d.fn(help='"From where to extract the file? Absolute path on the containers file system. Must be located in `/home/securecodebox/`. E.g. `/home/securecodebox/nmap-results.xml`"', args=[d.arg(name='location', type=d.T.string)]),
      withLocation(location): { spec+: { extractResults+: { location: location } } },
      '#withType':: d.fn(help='"Indicates the type of the file. Usually a combination of the scanner name and file type. E.g. `nmap-xml`"', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { extractResults+: { type: type } } },
    },
    '#jobTemplate':: d.obj(help='"Template of the kubernetes job to create when running the scan"'),
    jobTemplate: {
      '#spec':: d.obj(help='"Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
      spec: {
        ...
        template: {
          ...
          spec: {
            ...
            os: {
              ...
              withName(name): { spec+: { jobTemplate+: { spec+: { template+: { spec+: { os+: { name: name } } } } } } },
            },
            ...
            securityContext: {
              ...
              windowsOptions: {
                ...
                '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container. This field is alpha-level and will only be honored by components that enable the WindowsHostProcessContainers feature flag. Setting this field without the feature flag will result in errors when validating the Pod. All of a Pod's containers must have the same effective HostProcess value (it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).  In addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
                withHostProcess(hostProcess): { spec+: { jobTemplate+: { spec+: { template+: { spec+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } } } } },
                '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          ...
          withMetadata(metadata): { spec+: { jobTemplate+: { spec+: { template+: { metadata: metadata } } } } },
          ...
          withMetadataMixin(metadata): { spec+: { jobTemplate+: { spec+: { template+: { metadata+: metadata } } } } },
        },
      ...
      '#status':: d.obj(help='"Current status of a job. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
      status: {
        '#conditions':: d.obj(help="\"The latest available observations of an object's current state. When a Job fails, one of the conditions will have type \\\"Failed\\\" and status true. When a Job is suspended, one of the conditions will have type \\\"Suspended\\\" and status true; when the Job is resumed, the status of this condition will become false. When a Job is completed, one of the conditions will have type \\\"Complete\\\" and status true. More info: https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/\""),
        conditions: {
          '#withLastProbeTime':: d.fn(help='"Last time the condition was checked."', args=[d.arg(name='lastProbeTime', type=d.T.string)]),
          withLastProbeTime(lastProbeTime): { lastProbeTime: lastProbeTime },
          '#withLastTransitionTime':: d.fn(help='"Last time the condition transit from one status to another."', args=[d.arg(name='lastTransitionTime', type=d.T.string)]),
          ...
          '#withStatus':: d.fn(help='"Status of the condition, one of True, False, Unknown."', args=[d.arg(name='status', type=d.T.string)]),
        ...
        uncountedTerminatedPods: {
          ...
          withFailedMixin(failed): { spec+: { jobTemplate+: { status+: { uncountedTerminatedPods+: { failed+: if std.isArray(v=failed) then failed else [failed] } } } } },
          '#withSucceeded':: d.fn(help='"Succeeded holds UIDs of succeeded Pods."', args=[d.arg(name='succeeded', type=d.T.array)]),
          withSucceeded(succeeded): { spec+: { jobTemplate+: { status+: { uncountedTerminatedPods+: { succeeded: if std.isArray(v=succeeded) then succeeded else [succeeded] } } } } },
          ...
          withSucceededMixin(succeeded): { spec+: { jobTemplate+: { status+: { uncountedTerminatedPods+: { succeeded+: if std.isArray(v=succeeded) then succeeded else [succeeded] } } } } },
        },
        '#withActive':: d.fn(help='"The number of pending and running pods."', args=[d.arg(name='active', type=d.T.integer)]),
        withActive(active): { spec+: { jobTemplate+: { status+: { active: active } } } },
        ...
        withCompletedIndexes(completedIndexes): { spec+: { jobTemplate+: { status+: { completedIndexes: completedIndexes } } } },
        '#withCompletionTime':: d.fn(help='"Represents time when the job was completed. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC. The completion time is only set when the job finishes successfully."', args=[d.arg(name='completionTime', type=d.T.string)]),
        withCompletionTime(completionTime): { spec+: { jobTemplate+: { status+: { completionTime: completionTime } } } },
        ...
        withConditions(conditions): { spec+: { jobTemplate+: { status+: { conditions: if std.isArray(v=conditions) then conditions else [conditions] } } } },
        ...
        withConditionsMixin(conditions): { spec+: { jobTemplate+: { status+: { conditions+: if std.isArray(v=conditions) then conditions else [conditions] } } } },
        '#withFailed':: d.fn(help='"The number of pods which reached phase Failed."', args=[d.arg(name='failed', type=d.T.integer)]),
        withFailed(failed): { spec+: { jobTemplate+: { status+: { failed: failed } } } },
        ...
        withReady(ready): { spec+: { jobTemplate+: { status+: { ready: ready } } } },
        '#withStartTime':: d.fn(help='"Represents time when the job controller started processing a job. When a Job is created in the suspended state, this field is not set until the first time it is resumed. This field is reset every time a Job is resumed from suspension. It is represented in RFC3339 form and is in UTC."', args=[d.arg(name='startTime', type=d.T.string)]),
        withStartTime(startTime): { spec+: { jobTemplate+: { status+: { startTime: startTime } } } },
        '#withSucceeded':: d.fn(help='"The number of pods which reached phase Succeeded."', args=[d.arg(name='succeeded', type=d.T.integer)]),
        withSucceeded(succeeded): { spec+: { jobTemplate+: { status+: { succeeded: succeeded } } } },
      },
      ...
      withApiVersion(apiVersion): { spec+: { jobTemplate+: { apiVersion: apiVersion } } },
      ...
      withKind(kind): { spec+: { jobTemplate+: { kind: kind } } },
      '#withMetadata':: d.fn(help="\"Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata\"", args=[d.arg(name='metadata', type=d.T.object)]),
      withMetadata(metadata): { spec+: { jobTemplate+: { metadata: metadata } } },
      '#withMetadataMixin':: d.fn(help="\"Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='metadata', type=d.T.object)]),
      withMetadataMixin(metadata): { spec+: { jobTemplate+: { metadata+: metadata } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
