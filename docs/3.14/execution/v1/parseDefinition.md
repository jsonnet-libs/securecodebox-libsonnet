---
permalink: /3.14/execution/v1/parseDefinition/
---

# execution.v1.parseDefinition
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withScopeLimiterAliases(scopeLimiterAliases)`](#fn-specwithscopelimiteraliases)
  * [`fn withScopeLimiterAliasesMixin(scopeLimiterAliases)`](#fn-specwithscopelimiteraliasesmixin)
...
new returns an instance of ParseDefinition
...
### fn spec.withScopeLimiterAliases

```ts
withScopeLimiterAliases(scopeLimiterAliases)
```



### fn spec.withScopeLimiterAliasesMixin

```ts
withScopeLimiterAliasesMixin(scopeLimiterAliases)
```
