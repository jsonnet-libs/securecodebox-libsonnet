{
  ...
  '#':: d.pkg(name='cascadingRule', url='', help='"CascadingRule is the Schema for the cascadingrules API"'),
  ...
  '#new':: d.fn(help='new returns an instance of CascadingRule', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'cascading.securecodebox.io/v1',
    kind: 'CascadingRule',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"CascadingRuleSpec defines the desired state of CascadingRule"'),
  spec: {
    '#matches':: d.obj(help='"Matches defines to which findings the CascadingRule should apply"'),
    matches: {
      '#anyOf':: d.obj(help=''),
      anyOf: {
        ...
        '#withCategory':: d.fn(help='', args=[d.arg(name='category', type=d.T.string)]),
        ...
        '#withOsi_layer':: d.fn(help='', args=[d.arg(name='osi_layer', type=d.T.string)]),
        withOsi_layer(osi_layer): { osi_layer: osi_layer },
        '#withSeverity':: d.fn(help='', args=[d.arg(name='severity', type=d.T.string)]),
        withSeverity(severity): { severity: severity },
      },
      '#withAnyOf':: d.fn(help='', args=[d.arg(name='anyOf', type=d.T.array)]),
      withAnyOf(anyOf): { spec+: { matches+: { anyOf: if std.isArray(v=anyOf) then anyOf else [anyOf] } } },
      '#withAnyOfMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='anyOf', type=d.T.array)]),
      withAnyOfMixin(anyOf): { spec+: { matches+: { anyOf+: if std.isArray(v=anyOf) then anyOf else [anyOf] } } },
    },
    '#scanSpec':: d.obj(help='"ScanSpec defines how the cascaded scan should look like"'),
    scanSpec: {
      '#affinity':: d.obj(help='"Affinity allows to specify a node affinity, to control on which nodes you want a scan to run. See: https://kubernetes.io/docs/tasks/configure-pod-container/assign-pods-nodes-using-node-affinity/"'),
      affinity: {
        ...
        nodeAffinity: {
          ...
          requiredDuringSchedulingIgnoredDuringExecution: {
            ...
            withNodeSelectorTerms(nodeSelectorTerms): { spec+: { scanSpec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
            ...
            withNodeSelectorTermsMixin(nodeSelectorTerms): { spec+: { scanSpec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
          },
          ...
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        ...
        podAffinity: {
          ...
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        ...
        podAntiAffinity: {
          ...
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy the anti-affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions. The node that is most preferred is the one with the greatest sum of weights, i.e. for each node that meets all of the scheduling requirements (resource request, requiredDuringScheduling anti-affinity expressions, etc.), compute a sum by iterating through the elements of this field and adding \\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the node(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { scanSpec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
      },
      '#cascades':: d.obj(help='"CascadeSpec describes how and when cascading scans should be generated."'),
      cascades: {
        '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
        matchExpressions: {
          '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#scopeLimiter':: d.obj(help='"InheritLabels defines whether cascading scans should inherit labels from the parent scan"'),
        scopeLimiter: {
          '#allOf':: d.obj(help='"AllOf is a list of label selector requirements. The requirements are ANDed."'),
          allOf: {
            '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { key: key },
            '#withOperator':: d.fn(help="\"operator represents a key's relationship to a set of values.\"", args=[d.arg(name='operator', type=d.T.string)]),
            withOperator(operator): { operator: operator },
            '#withValues':: d.fn(help='"values is an array of string values."', args=[d.arg(name='values', type=d.T.array)]),
            withValues(values): { values: if std.isArray(v=values) then values else [values] },
            '#withValuesMixin':: d.fn(help='"values is an array of string values."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='values', type=d.T.array)]),
            withValuesMixin(values): { values+: if std.isArray(v=values) then values else [values] },
          },
          '#anyOf':: d.obj(help='"AnyOf is a list of label selector requirements. The requirements are ANDed."'),
          anyOf: {
            '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { key: key },
            '#withOperator':: d.fn(help="\"operator represents a key's relationship to a set of values.\"", args=[d.arg(name='operator', type=d.T.string)]),
          ...
          '#noneOf':: d.obj(help='"NoneOf is a list of label selector requirements. The requirements are ANDed."'),
          noneOf: {
            '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { key: key },
            '#withOperator':: d.fn(help="\"operator represents a key's relationship to a set of values.\"", args=[d.arg(name='operator', type=d.T.string)]),
          ...
          '#withAllOf':: d.fn(help='"AllOf is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='allOf', type=d.T.array)]),
          withAllOf(allOf): { spec+: { scanSpec+: { cascades+: { scopeLimiter+: { allOf: if std.isArray(v=allOf) then allOf else [allOf] } } } } },
          '#withAllOfMixin':: d.fn(help='"AllOf is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allOf', type=d.T.array)]),
          withAllOfMixin(allOf): { spec+: { scanSpec+: { cascades+: { scopeLimiter+: { allOf+: if std.isArray(v=allOf) then allOf else [allOf] } } } } },
          '#withAnyOf':: d.fn(help='"AnyOf is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='anyOf', type=d.T.array)]),
          withAnyOf(anyOf): { spec+: { scanSpec+: { cascades+: { scopeLimiter+: { anyOf: if std.isArray(v=anyOf) then anyOf else [anyOf] } } } } },
          '#withAnyOfMixin':: d.fn(help='"AnyOf is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='anyOf', type=d.T.array)]),
          withAnyOfMixin(anyOf): { spec+: { scanSpec+: { cascades+: { scopeLimiter+: { anyOf+: if std.isArray(v=anyOf) then anyOf else [anyOf] } } } } },
          '#withNoneOf':: d.fn(help='"NoneOf is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='noneOf', type=d.T.array)]),
          withNoneOf(noneOf): { spec+: { scanSpec+: { cascades+: { scopeLimiter+: { noneOf: if std.isArray(v=noneOf) then noneOf else [noneOf] } } } } },
          '#withNoneOfMixin':: d.fn(help='"NoneOf is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='noneOf', type=d.T.array)]),
          withNoneOfMixin(noneOf): { spec+: { scanSpec+: { cascades+: { scopeLimiter+: { noneOf+: if std.isArray(v=noneOf) then noneOf else [noneOf] } } } } },
          '#withValidOnMissingRender':: d.fn(help='"ValidOnMissingRender defines whether if a templating variable is not present, that condition should match"', args=[d.arg(name='validOnMissingRender', type=d.T.boolean)]),
          withValidOnMissingRender(validOnMissingRender): { spec+: { scanSpec+: { cascades+: { scopeLimiter+: { validOnMissingRender: validOnMissingRender } } } } },
        },
        '#withInheritAffinity':: d.fn(help='"InheritAffinity defines whether cascading scans should inherit affinity from the parent scan."', args=[d.arg(name='inheritAffinity', type=d.T.boolean)]),
        withInheritAffinity(inheritAffinity): { spec+: { scanSpec+: { cascades+: { inheritAffinity: inheritAffinity } } } },
        '#withInheritAnnotations':: d.fn(help='"InheritAnnotations defines whether cascading scans should inherit annotations from the parent scan"', args=[d.arg(name='inheritAnnotations', type=d.T.boolean)]),
        withInheritAnnotations(inheritAnnotations): { spec+: { scanSpec+: { cascades+: { inheritAnnotations: inheritAnnotations } } } },
        '#withInheritEnv':: d.fn(help='"InheritEnv defines whether cascading scans should inherit environment variables from the parent scan"', args=[d.arg(name='inheritEnv', type=d.T.boolean)]),
        withInheritEnv(inheritEnv): { spec+: { scanSpec+: { cascades+: { inheritEnv: inheritEnv } } } },
        '#withInheritHookSelector':: d.fn(help='"InheritHookSelector defines whether cascading scans should inherit hookSelector from the parent scan."', args=[d.arg(name='inheritHookSelector', type=d.T.boolean)]),
        withInheritHookSelector(inheritHookSelector): { spec+: { scanSpec+: { cascades+: { inheritHookSelector: inheritHookSelector } } } },
        '#withInheritInitContainers':: d.fn(help='"InheritInitContainers defines whether cascading scans should inherit initContainers from the parent scan. Usually only useful when combined with inheritVolumes."', args=[d.arg(name='inheritInitContainers', type=d.T.boolean)]),
        withInheritInitContainers(inheritInitContainers): { spec+: { scanSpec+: { cascades+: { inheritInitContainers: inheritInitContainers } } } },
        '#withInheritLabels':: d.fn(help='"InheritLabels defines whether cascading scans should inherit labels from the parent scan"', args=[d.arg(name='inheritLabels', type=d.T.boolean)]),
        withInheritLabels(inheritLabels): { spec+: { scanSpec+: { cascades+: { inheritLabels: inheritLabels } } } },
        '#withInheritTolerations':: d.fn(help='"InheritTolerations defines whether cascading scans should inherit tolerations from the parent scan."', args=[d.arg(name='inheritTolerations', type=d.T.boolean)]),
        withInheritTolerations(inheritTolerations): { spec+: { scanSpec+: { cascades+: { inheritTolerations: inheritTolerations } } } },
        '#withInheritVolumes':: d.fn(help='"InheritVolumes defines whether cascading scans should inherit volumes and volume mounts from the parent scan"', args=[d.arg(name='inheritVolumes', type=d.T.boolean)]),
        withInheritVolumes(inheritVolumes): { spec+: { scanSpec+: { cascades+: { inheritVolumes: inheritVolumes } } } },
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { scanSpec+: { cascades+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { scanSpec+: { cascades+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { scanSpec+: { cascades+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { scanSpec+: { cascades+: { matchLabels+: matchLabels } } } },
      },
      '#env':: d.obj(help='"Env allows to specify environment vars for the scanner container. These will be merged will the env vars specified for the first container of the pod defined in the ScanType"'),
      env: {
      ...
      '#hookSelector':: d.obj(help='"HookSelector allows to specify a LabelSelector with which the hooks are selected."'),
      hookSelector: {
        '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
        matchExpressions: {
          '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressions(matchExpressions): { spec+: { scanSpec+: { hookSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { scanSpec+: { hookSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { scanSpec+: { hookSelector+: { matchLabels: matchLabels } } } },
        '#withMatchLabelsMixin':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabelsMixin(matchLabels): { spec+: { scanSpec+: { hookSelector+: { matchLabels+: matchLabels } } } },
      },
      '#initContainers':: d.obj(help='"InitContainers allows to specify init containers for the scan container, to pre-load data into them."'),
      initContainers: {
      ...
      '#resources':: d.obj(help='"Resources lets you control resource limits and requests for the parser container. See https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"'),
      resources: {
        '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
        withLimits(limits): { spec+: { scanSpec+: { resources+: { limits: limits } } } },
        '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
        withLimitsMixin(limits): { spec+: { scanSpec+: { resources+: { limits+: limits } } } },
        '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
        withRequests(requests): { spec+: { scanSpec+: { resources+: { requests: requests } } } },
        '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
        withRequestsMixin(requests): { spec+: { scanSpec+: { resources+: { requests+: requests } } } },
      },
      '#tolerations':: d.obj(help='"Tolerations are a different way to control on which nodes your scan is executed. See https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/"'),
      tolerations: {
      ...
      '#volumeMounts':: d.obj(help='"VolumeMounts allows to specify volume mounts for the scan container."'),
      volumeMounts: {
        '#withMountPath':: d.fn(help="\"Path within the container at which the volume should be mounted.  Must not contain ':'.\"", args=[d.arg(name='mountPath', type=d.T.string)]),
        withMountPath(mountPath): { mountPath: mountPath },
        '#withMountPropagation':: d.fn(help='"mountPropagation determines how mounts are propagated from the host to container and the other way around. When not set, MountPropagationNone is used. This field is beta in 1.10."', args=[d.arg(name='mountPropagation', type=d.T.string)]),
      ...
      '#volumes':: d.obj(help='"Volumes allows to specify volumes for the scan container."'),
      volumes: {
      ...
      '#withEnv':: d.fn(help='"Env allows to specify environment vars for the scanner container. These will be merged will the env vars specified for the first container of the pod defined in the ScanType"', args=[d.arg(name='env', type=d.T.array)]),
      withEnv(env): { spec+: { scanSpec+: { env: if std.isArray(v=env) then env else [env] } } },
      '#withEnvMixin':: d.fn(help='"Env allows to specify environment vars for the scanner container. These will be merged will the env vars specified for the first container of the pod defined in the ScanType"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
      withEnvMixin(env): { spec+: { scanSpec+: { env+: if std.isArray(v=env) then env else [env] } } },
      '#withInitContainers':: d.fn(help='"InitContainers allows to specify init containers for the scan container, to pre-load data into them."', args=[d.arg(name='initContainers', type=d.T.array)]),
      withInitContainers(initContainers): { spec+: { scanSpec+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      '#withInitContainersMixin':: d.fn(help='"InitContainers allows to specify init containers for the scan container, to pre-load data into them."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='initContainers', type=d.T.array)]),
      withInitContainersMixin(initContainers): { spec+: { scanSpec+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      '#withParameters':: d.fn(help='"All CLI parameters to configure the scan container."', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { spec+: { scanSpec+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='"All CLI parameters to configure the scan container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { spec+: { scanSpec+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withScanType':: d.fn(help='"The name of the scanType which should be started."', args=[d.arg(name='scanType', type=d.T.string)]),
      withScanType(scanType): { spec+: { scanSpec+: { scanType: scanType } } },
      '#withTolerations':: d.fn(help='"Tolerations are a different way to control on which nodes your scan is executed. See https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/"', args=[d.arg(name='tolerations', type=d.T.array)]),
      withTolerations(tolerations): { spec+: { scanSpec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      '#withTolerationsMixin':: d.fn(help='"Tolerations are a different way to control on which nodes your scan is executed. See https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tolerations', type=d.T.array)]),
      withTolerationsMixin(tolerations): { spec+: { scanSpec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      '#withVolumeMounts':: d.fn(help='"VolumeMounts allows to specify volume mounts for the scan container."', args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMounts(volumeMounts): { spec+: { scanSpec+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withVolumeMountsMixin':: d.fn(help='"VolumeMounts allows to specify volume mounts for the scan container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMountsMixin(volumeMounts): { spec+: { scanSpec+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withVolumes':: d.fn(help='"Volumes allows to specify volumes for the scan container."', args=[d.arg(name='volumes', type=d.T.array)]),
      withVolumes(volumes): { spec+: { scanSpec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } },
      '#withVolumesMixin':: d.fn(help='"Volumes allows to specify volumes for the scan container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
      withVolumesMixin(volumes): { spec+: { scanSpec+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } },
    },
    '#withScanAnnotations':: d.fn(help='"ScanAnnotations define additional annotations for cascading scans"', args=[d.arg(name='scanAnnotations', type=d.T.object)]),
    withScanAnnotations(scanAnnotations): { spec+: { scanAnnotations: scanAnnotations } },
    '#withScanAnnotationsMixin':: d.fn(help='"ScanAnnotations define additional annotations for cascading scans"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scanAnnotations', type=d.T.object)]),
    withScanAnnotationsMixin(scanAnnotations): { spec+: { scanAnnotations+: scanAnnotations } },
    '#withScanLabels':: d.fn(help='"ScanLabels define additional labels for cascading scans"', args=[d.arg(name='scanLabels', type=d.T.object)]),
    withScanLabels(scanLabels): { spec+: { scanLabels: scanLabels } },
    '#withScanLabelsMixin':: d.fn(help='"ScanLabels define additional labels for cascading scans"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scanLabels', type=d.T.object)]),
    withScanLabelsMixin(scanLabels): { spec+: { scanLabels+: scanLabels } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
