{
  ...
  '#':: d.pkg(name='scanCompletionHook', url='', help='"ScanCompletionHook is the Schema for the ScanCompletionHooks API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ScanCompletionHook', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'execution.securecodebox.io/v1',
    kind: 'ScanCompletionHook',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ScanCompletionHookSpec defines the desired state of ScanCompletionHook"'),
  spec: {
    '#affinity':: d.obj(help='"Affinity allows to specify a node affinity, to control on which nodes you want a hook to run. See: https://kubernetes.io/docs/tasks/configure-pod-container/assign-pods-nodes-using-node-affinity/"'),
    affinity: {
    ...
    '#env':: d.obj(help='"Env allows to specify environment vars for the hooks container."'),
    env: {
    ...
    '#imagePullSecrets':: d.obj(help='"ImagePullSecrets used to access private hooks images"'),
    imagePullSecrets: {
      '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    },
    ...
    '#tolerations':: d.obj(help='"Tolerations are a different way to control on which nodes your hook is executed. See https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/"'),
    tolerations: {
    ...
    '#volumeMounts':: d.obj(help='"VolumeMounts allows to specify volume mounts for the hooks container."'),
    volumeMounts: {
    ...
    '#volumes':: d.obj(help='"Volumes allows to specify volumes for the hooks container."'),
    volumes: {
    ...
    '#withEnv':: d.fn(help='"Env allows to specify environment vars for the hooks container."', args=[d.arg(name='env', type=d.T.array)]),
    withEnv(env): { spec+: { env: if std.isArray(v=env) then env else [env] } },
    '#withEnvMixin':: d.fn(help='"Env allows to specify environment vars for the hooks container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
    withEnvMixin(env): { spec+: { env+: if std.isArray(v=env) then env else [env] } },
    '#withImage':: d.fn(help='"Image is the container image for the hooks kubernetes job"', args=[d.arg(name='image', type=d.T.string)]),
    ...
    '#withImagePullSecrets':: d.fn(help='"ImagePullSecrets used to access private hooks images"', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
    ...
    '#withPriority':: d.fn(help='"Higher priority hooks run before low priority hooks. Within a priority class ReadAndWrite hooks are started before ReadOnly hooks, ReadAndWrite hooks wil be launched in serial, and ReadOnly hooks will be launched in parallel."', args=[d.arg(name='priority', type=d.T.integer)]),
    withPriority(priority): { spec+: { priority: priority } },
    '#withServiceAccountName':: d.fn(help='"ServiceAccountName Name of the serviceAccount Name used. Should only be used if your hook needs specifc RBAC Access. Otherwise the hook is run using a \\"scan-completion-hook\\" service account. The service account should have at least \\"get\\" rights on scans.execution.securecodebox.io, and \\"get\\" & \\"patch\\" scans.execution.securecodebox.io/status"', args=[d.arg(name='serviceAccountName', type=d.T.string)]),
    withServiceAccountName(serviceAccountName): { spec+: { serviceAccountName: serviceAccountName } },
    '#withTolerations':: d.fn(help='"Tolerations are a different way to control on which nodes your hook is executed. See https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/"', args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerations(tolerations): { spec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    '#withTolerationsMixin':: d.fn(help='"Tolerations are a different way to control on which nodes your hook is executed. See https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tolerations', type=d.T.array)]),
    withTolerationsMixin(tolerations): { spec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } },
    '#withTtlSecondsAfterFinished':: d.fn(help='"TTLSecondsAfterFinished configures the ttlSecondsAfterFinished field for the created hook job"', args=[d.arg(name='ttlSecondsAfterFinished', type=d.T.integer)]),
    withTtlSecondsAfterFinished(ttlSecondsAfterFinished): { spec+: { ttlSecondsAfterFinished: ttlSecondsAfterFinished } },
    '#withType':: d.fn(help='"Defines weather the hook should be able to change the findings or is run in a read only mode."', args=[d.arg(name='type', type=d.T.string)]),
    withType(type): { spec+: { type: type } },
    '#withVolumeMounts':: d.fn(help='"VolumeMounts allows to specify volume mounts for the hooks container."', args=[d.arg(name='volumeMounts', type=d.T.array)]),
    withVolumeMounts(volumeMounts): { spec+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } },
    '#withVolumeMountsMixin':: d.fn(help='"VolumeMounts allows to specify volume mounts for the hooks container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumeMounts', type=d.T.array)]),
    withVolumeMountsMixin(volumeMounts): { spec+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } },
    '#withVolumes':: d.fn(help='"Volumes allows to specify volumes for the hooks container."', args=[d.arg(name='volumes', type=d.T.array)]),
    withVolumes(volumes): { spec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } },
    '#withVolumesMixin':: d.fn(help='"Volumes allows to specify volumes for the hooks container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
