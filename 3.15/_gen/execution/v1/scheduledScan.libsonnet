{
  ...
  '#':: d.pkg(name='scheduledScan', url='', help='"ScheduledScan is the Schema for the scheduledscans API"'),
  ...
  '#new':: d.fn(help='new returns an instance of ScheduledScan', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'execution.securecodebox.io/v1',
    kind: 'ScheduledScan',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ScheduledScanSpec defines the desired state of ScheduledScan"'),
  spec: {
    '#scanSpec':: d.obj(help='"ScanSpec describes the scan which should be started regularly"'),
    scanSpec: {
    ...
    '#withFailedJobsHistoryLimit':: d.fn(help='"FailedJobsHistoryLimit determines how many failed past Scans will be kept until the oldest one will be deleted, defaults to 3. When set to 0, Scans will be deleted directly after failure"', args=[d.arg(name='failedJobsHistoryLimit', type=d.T.integer)]),
    withFailedJobsHistoryLimit(failedJobsHistoryLimit): { spec+: { failedJobsHistoryLimit: failedJobsHistoryLimit } },
    '#withInterval':: d.fn(help="\"Interval describes how often the scan should be repeated Examples: '12h', '30m'\"", args=[d.arg(name='interval', type=d.T.string)]),
    withInterval(interval): { spec+: { interval: interval } },
    '#withRetriggerOnScanTypeChange':: d.fn(help='"RetriggerOnScanTypeChange will automatically trigger a new scan for the scheduledScan if the referenced ScanType was updated"', args=[d.arg(name='retriggerOnScanTypeChange', type=d.T.boolean)]),
    withRetriggerOnScanTypeChange(retriggerOnScanTypeChange): { spec+: { retriggerOnScanTypeChange: retriggerOnScanTypeChange } },
    '#withSuccessfulJobsHistoryLimit':: d.fn(help='"SuccessfulJobsHistoryLimit determines how many past Scans will be kept until the oldest one will be deleted, defaults to 3. When set to 0, Scans will be deleted directly after completion"', args=[d.arg(name='successfulJobsHistoryLimit', type=d.T.integer)]),
